...
public class AssocTaxistaDAO {
    ...
    public void save(AssocTaxista a) {
    ...
    public void edit(AssocTaxista a) {
        PreparedStatement ps = null;
        Connection conn = null;
    ...
    public void delete(AssocTaxista a) {
        PreparedStatement ps = null;
        Connection conn = null;
    ...
    public List<AssocTaxista> listaTodosAssicTaxista() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                AssocTaxista a = new AssocTaxista();
